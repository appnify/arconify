import{aa as n,n as s,o as a,ag as p}from"./chunks/framework.y8UAToHR.js";const m=JSON.parse('{"title":"快速上手","description":"","frontmatter":{},"headers":[],"relativePath":"zh-CN/guide/getting-started.md","filePath":"zh-CN/guide/getting-started.md","lastUpdated":1709543079000}'),t={name:"zh-CN/guide/getting-started.md"},e=p(`<h1 class="anchor">快速上手 <a class="header-anchor" href="#快速上手" aria-label="Permalink to &quot;快速上手&quot;">​</a></h1><p>通过该章节，你将了解到如何快速开始使用 Arconify UI。在开始之前，你需要掌握了 <a href="https://v3.cn.vuejs.org/" target="_blank" rel="noreferrer">Vue3</a> 的基本使用。</p><h2 class="anchor"><span id="要求" class="anchor__title">要求</span><a class="anchor__link" href="#要求">#</a></h2><p>为了减少不必要的重复依赖，部分依赖外置，因此需要你的项目内有如下依赖：</p><ul><li><a href="./.html">lodash-es</a>：工具库</li><li><a href="./.html">@arco-design/web-vue</a>：字条跳动出品的 Vue3 组件库</li></ul><h2 class="anchor"><span id="安装" class="anchor__title">安装</span><a class="anchor__link" href="#安装">#</a></h2><p>根据你使用的包管理工具，选择以下其中一种命令进行安装：</p><div class="language-sh"><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="language-sh" lang="sh" tabindex="-1"><code><span class="token comment"># 使用 pnpm</span>
